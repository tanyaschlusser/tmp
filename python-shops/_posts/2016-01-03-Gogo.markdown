...
<div
  class="flex-image"
  style="width:21.32%;margin:1em;background-mage:url({{ site.baseurl }}/div/2016/gogo/GogoOpenSpace.jpg)"
  name="Gogo open space area"
></div>
<div
  class="flex-image"
  style="width:20.96%;margin:1em;background-image:url({{ site.baseurl }}/div/2016/gogo/GogoFoosball.jpg"
